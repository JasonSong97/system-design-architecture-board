...
public class ArticleApiTest {
    ...
    @Test
    void readTest() {
        ArticleResponse response = read(145532936912162816L); // createTest()에서 생성한 articleId
        System.out.println("response = " + response);
    }
    ...
    @Test
    void updateTest() {
        update(145532936912162816L); // createTest()에서 생성한 articleId
        ArticleResponse response = read(145532936912162816L);
        System.out.println("response = " + response);
    }
    ...
    void deleteTest() {
        restClient.delete()
                .uri("/v1/articles/{articleId}", 145532936912162816L)
                .retrieve();
    }
    ...
    void readAllTest() {
        ArticlePageResponse response = restClient.get()
                .uri("/v1/articles?boardId=1&pageSize=30&page=50000") // 1번도 가능
                .retrieve()
