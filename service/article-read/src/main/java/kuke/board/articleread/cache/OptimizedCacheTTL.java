...
public class OptimizedCacheTTL {
    ...
    public static final long PHYSICAL_TTL_RELAY_SECONDS = 5;
    ...
    public static OptimizedCacheTTL of(long ttlSeconds) {
        ...
        optimizedCacheTTL.physicalTTL = optimizedCacheTTL.logicalTTL.plusSeconds(PHYSICAL_TTL_RELAY_SECONDS);
